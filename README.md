...
Here are some files that might help you configure the module in your environment:
 ...
 - Sample partitions file for the 8MB Flash, with 2 OTA Slots, EEPROM and SPIFF. Copy it to the root folder of your PlatformIO project (copy or [download](partitions_8M.csv)) 
 ...
 - Board definition file for PlatformIO. Copy it to a to folder named *boards* in the root folder of your PlatformIO project or your  *\<PROFILE\>/*.platformio/boards folder (copy or [download](twilightlord-esp32-8MB.json))
